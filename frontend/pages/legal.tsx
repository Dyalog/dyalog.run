        ...
        <main className="my-3 px-8 md:container md:mx-auto grow pb-2">
          <article id="Preamble">
            ...
            <p className="text-justify mb-3">
              dyalog.run is a <a href="https://en.wikipedia.org/wiki/Fork_(software_development)"
              ...
              Ltd</a> at <a href="https://dyalog.run" className="underline text-blue-500">https://dyalog.run</a> and its
              instance of the software repository is hosted at <a href="https://github.com/Dyalog/dyalog.run"
              className="underline text-blue-500">https://github.com/Dyalog/dyalog.run</a>.
            </p>
            <p className="text-justify mb-3">
              The principal purpose of dyalog.run is to support other websites hosted by Dyalog Ltd.
              In order to access dyalog.run directly you must agree to the <a href="#terms-of-use"
              className="underline text-blue-500">Terms of Use</a>.
            </p>
          </article>
          <article id="privacy-policy">
            ...
            <p className="text-justify mb-3">
              See also the general Dyalog <a href="https://www.dyalog.com/index.php?page=privacy-policy"
          ...
          <article id="terms-of-use">
            ...
            <p className="text-justify mb-3">
              <strong>"The Service"</strong> refers to the website at <a href="https://dyalog.run"
              className="underline text-blue-500">https://dyalog.run</a> and all services provided at that URL.
              This does not include the Software itself, but only the instance of the Software made available
              at <a href="https://dyalog.run" className="underline text-blue-500">https://dyalog.run</a>.
            </p>
            <p className="text-justify mb-3">
              Unless Dyalog Ltd grants you explicit written or electronic permission, you must not use <strong>the
                Service</strong>, except directly through the web page and as a result of your manual user interaction with it.
            </p>
            <p className="text-justify mb-3">
              The Software includes an "API", which is a programmatic interface for interacting with <strong>the
                Service</strong>, but this is for use only by <strong>the Service</strong> internally, and by
                other websites hosted by Dyalog Ltd. You are not permitted to use the API otherwise.
            </p>
          </article>
        </main>
        <Footer noLegalLink />
